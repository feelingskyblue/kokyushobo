...
// 閲覧モードの管理
function viewModeManager(viewModeBtn) {
  // 閲覧モード切り替え
  if (viewModeBtn) {
...
window.addEventListener('DOMContentLoaded', () => {
  const modeChangeBtn = document.querySelector('#modeChangeBtn');
  const modeChangeSubBtn = document.querySelector('#modeChangeSubBtn');
  viewModeManager(modeChangeBtn);
  viewModeManager(modeChangeSubBtn);
  linkUpdate();
  smoothscroll();
